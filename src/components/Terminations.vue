...
<div class="home">
    <div class="home-row-1">
        ...
        <div class="home-row-1-content">
            <p>
                Det er ikke altid let at opsige en medarbejder. Reglerne er mange – og det kan være en omkostningstung affære for arbejdsgiveren, hvis en opsigelsessituation ikke bliver håndteret korrekt.
            </p>
            <Pen />
        </div>
    </div>
